...
for root,dirs,files in os.walk ("//folder1//folder2//folder2//firmname//"):
    for each in check:
        for eachfile in files:
            if each in eachfile:
                ...
                if formatedtime == todaystr and not ("_" in root) and not ("NextGenSDP" in root) and not ("TRS1" in root) and not ("CRT1" in root) and not ("Daily" in eachfile) and not ("Month" in eachfile):
                ...
                if formatedtime == todaystr and not ("_" in root) and not ("NextGenSDP" in root) and not ("TRS1" in root) and not ("CRT1" in root) and not ("Daily" in eachfile):
...
pandasDF.to_csv("//folder1//folder2//folder3//Rishi//folder4//Position//position_macro_review_"+fdateformat+".csv")

pandasDF2.to_csv("//folder1//folder2//folder3//Rishi//folder4//Position//position_macro_review_"+fdateformat+".csv",mode = 'a',index = False)

pandasDF1.to_csv("//folder1//folder2//folder3//Rishi//folder4//Position//position_macro_review_"+fdateformat+".csv",mode = 'a')
